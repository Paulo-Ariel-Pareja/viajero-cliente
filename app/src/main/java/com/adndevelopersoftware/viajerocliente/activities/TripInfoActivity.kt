...
import com.adndevelopersoftware.viajerocliente.R
import com.adndevelopersoftware.viajerocliente.databinding.ActivityTripInfoBinding
import com.adndevelopersoftware.viajerocliente.models.Price
import com.adndevelopersoftware.viajerocliente.providers.ConfigProvider
...
class TripInfoActivity : AppCompatActivity(), OnMapReadyCallback, Listener, DirectionUtil.DirectionCallBack {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.txtOrigen.text = extraOriginName
        binding.txtDestino.text = extraDestinationName
        ...
        binding.btnConfirmar.setOnClickListener { goToSearchDriver() }
    }
    ...
    private fun getPrices(distance: Double, time: Double) {
        ...
        configProvider.getPrice().addOnSuccessListener { document ->
            if (document.exists()) {
                val prices = document.toObject(Price::class.java)
                ...
                binding.txtPrecio.text = "$minTotalString - $maxTotalString$"
    ...
    override fun pathFindFinish(
        ...
        binding.txtTiempoYDistancia.text = "$timeString mins - $distanceString km"
