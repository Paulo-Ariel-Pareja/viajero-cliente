...
import com.adndevelopersoftware.viajerocliente.databinding.ActivitySearchBinding
import com.adndevelopersoftware.viajerocliente.models.Booking
import com.adndevelopersoftware.viajerocliente.models.Driver
...
import com.adndevelopersoftware.viajerocliente.providers.BookingProvider
import com.adndevelopersoftware.viajerocliente.providers.DriverProvider
import com.adndevelopersoftware.viajerocliente.providers.GeoProvider
import com.adndevelopersoftware.viajerocliente.providers.NotificationProvider
        ...
        geoProvider.getNearbyDrivers(originLatLng!!, radius).addGeoQueryEventListener(object: GeoQueryEventListener {
            ...
            override fun onKeyEntered(documentID: String, location: GeoPoint) {
                if (!isDriverFound) {
                    ...
                    binding.txtBuscando.text = "CONDUCTOR ENCONTRADO\nESPERANDO RESPUESTA"
            ...
            override fun onGeoQueryReady() {
                if (!isDriverFound) {
                    ...
                    if (radius > limitRadius) {
                        binding.txtBuscando.text = "NO SE ENCONTRO NINGUN CONDUCTOR"
                        return
                    }
                    else {
                        getClosestDriver()
